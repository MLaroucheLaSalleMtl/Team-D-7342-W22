...
namespace Lowscope.Saving.Data
{
    public class SaveSettings : ScriptableObject
    {
        ...
        private void OnValidate()
        {
            ...
            if (saveDirectory == SaveDirectory.GameFolderDesktopOnly)
            {
                saveDirectory = SaveDirectory.UnityPersistentDataDirectory;
                FeatureNotAvailableError();
            }

            if (fileValidation == SaveFileValidation.ConvertToType)
            {
                fileValidation = SaveFileValidation.GiveError;
                FeatureNotAvailableError();
            }

            if (storageType == StorageType.SQLiteExperimental)
            {
        ...
        private static void FeatureNotAvailableError()
        {
            Debug.Log("Error: This feature is not available in free version of Component Save System");
        }
        ...
        [Header("This is why some features are missing. This plugin has been added to ensure a robust saving experience.")]
        [Header("Note: RPG Farming Kit uses a free, trimmed down version of the Component Save System plugin.")]
        ...
        /// <summary>
        /// You can learn more about the persistent directory here:
        ...
        [Tooltip("You can learn more about the persistent directory when searching for Application.persistentDataPath in the Unity documentation." +
            "\n\nNote that it is reccomended to use the first option for most platforms. When using the game folder option in the editor, it will save the game in the project folder.")]
        public SaveDirectory saveDirectory = SaveDirectory.UnityPersistentDataDirectory;
        ...
        public string temporaryFolderName = "TempSaveData";
        ...
        [Header("Auto Save (Not functional in free version)")]
        ...
        [Header("Extras (Not functional in free version)")]
        ...
        [Header("Storage Settings - Encryption (Not functional in free version)")]
